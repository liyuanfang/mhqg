...
from dataset import collate_fn, QGDataset
from transformer.Question_Generator import QuestionGenerator
...
def main():
    ...
    test_src_word_insts = read_instances_from_file(
        opt.src,
        preprocess_settings.max_src_word_seq_len,
