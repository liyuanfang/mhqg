...
class QuestionGenerator(object):
    ...
    def __init__(self, opt):
        ...
        model = Transformer(opt=opt,
            n_src_vocab=model_opt.src_vocab_size,
            n_tgt_vocab=model_opt.tgt_vocab_size,
            src_len_max_seq=model_opt.max_src_token_seq_len,
            tgt_len_max_seq=model_opt.max_tgt_token_seq_len,
    ...
    def generate_question_batch(self, src_seq, src_pos):
        '''
        ...
        with torch.no_grad():
            ...
            for len_dec_seq in range(1, self.model_opt.max_tgt_token_seq_len + 1):
